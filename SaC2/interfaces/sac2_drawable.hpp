...
template<typename T>
inline sac2_status_t Drawable<T>::set_position(float x, float y)
{
...
template<typename T>
inline sac2_status_t Drawable<T>::set_scale(float x, float y)
{
...
template<typename T>
inline sac2_status_t Drawable<T>::set_rotation(float angle)
{
...
template<typename T>
inline sac2_status_t Drawable<T>::move(float x, float y)
{
...
template<typename T>
inline sac2_status_t Drawable<T>::rotate(float angle)
{
...
template<typename T>
inline sac2_status_t Drawable<T>::reset()
{
